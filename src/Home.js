        ...
        <form className="p-3 bg-light form-inline justify-content-center">
            <div className="row">
                <div className="col-auto">
                    <h3 className="mb-2 ms-2">Base currency: <b className="mr-2">1</b></h3>
                </div>
                <div className="col-auto">
                    <select value={base} onChange={this.changeBase} className="form-select form-select-lg mb-2" disabled={loading}>
                        {Object.keys(currencies).map(currencyAcronym => <option key={currencyAcronym} value={currencyAcronym} disabled={loading}>{currencyAcronym}</option>)}
                    </select>
                </div>
            </div>
        </form>
